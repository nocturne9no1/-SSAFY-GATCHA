...
export default function GameDetail() {
  ...
  useEffect(() => {
    axios({
      ...
      .then(res => (
        setGame(res.data[0],
        setTagList(res.data[0].tags.slice(0, 5))
          )))
  ...
  return(
    <div className="game_detail">
      ...
      <div className="trailer">
         ...
         */}
         <iframe key={videoId} src={`https://www.youtube.com/embed/${videoId}?showinfo=0&enablejsapi=1&origin=http://localhost:3000`} width='100%' height='100%' ></iframe>
      </div>
      <div className="game_info">
        ...
        <div className="game_info_detail">
          <div className="price">
            ...
            <span><i onClick={clickSteam} className="fab fa-steam"></i></span>
          </div>
          <div className="genre">
